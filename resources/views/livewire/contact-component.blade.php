...
<div class="page-section">
    <div class="container">
        ...
        <form action="{{route('contactUs')}}" class="contact-form" >
            <div class="row mb-3">
                ...
                <div class="col-12 py-2 wow fadeInUp">
                    ...
                    <input type="phoneNumber"  class="form-control" placeholder="Enter number.." name="phoneNumber">
                ...
                <div class="col-12 py-2 wow fadeInUp">
                    <label >Message</label>
                    <textarea  class="form-control" rows="8" placeholder="Enter Message.." name="message"></textarea>
